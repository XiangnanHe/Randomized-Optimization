 ...
 * @version 1.0
 */
public class ContinuousPeaks_test {
    /** The n value */
    ...
    public static void main(String[] args) {
        ...
        int[] iters = {10,100,500,1000,2000,5000};
        //int[] iters = {10};
        int testRuns = 10;
        ...
        for (int i = 0; i < coolings.length; i++){
            ...
            String final_result = "";
            final_result =
                    "sa" + "," + Double.toString(coolings[i]) + "," + Integer.toString(average_sa) + "," + Double.toString(averagetime_sa);
