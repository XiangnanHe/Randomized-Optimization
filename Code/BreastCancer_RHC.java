...
/**
 * Created by Xiangnan He on 10/13/2017.
 */
...
public class BreastCancer_RHC {
    private static Instance[] instances = initializeInstances();
    private static Instance[] train_set = Arrays.copyOfRange(instances, 0, 397);
    private static Instance[] test_set = Arrays.copyOfRange(instances, 398, 568);
    ...
    public static void main(String[] args) {
        ...
        for (int trainingIterations : iterations) {
            ...
            for (int i = 0; i < oa.length; i++) {
                ...
                write_output_to_file("Optimization_Results", "BreastCancer_RHC.csv", final_result, true);
    ...
    private static Instance[] initializeInstances() {
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("src/opt/xhe321/BreastCancer.csv")));
            ...
            for(int i = 0; i < attributes.length; i++) {
                ...
                attributes[i][0] = new double[30]; // 9 attributes
